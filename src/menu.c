...
extern void resetGame(); // garante que resetGame() definido em main.cpp ser� linkado

// Fun��o para desenhar cada bot�o
void desenhaBotao(int x, int y, int largura, int altura, const char* texto) {
    ...
    // Desenha texto centralizado no bot�o
    glColor3f(1, 1, 1);
    int len = 0;
    const char* c;
...
void desenhaMenu() {
    ...
    // Configura proje��o 2D tempor�ria para o menu
...
// Fun��o para tratar clique do mouse no menu
