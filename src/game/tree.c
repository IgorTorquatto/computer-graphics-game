...
extern Model treeModel;  // Modelo da �rvore carregado externamente
...
void drawTrees() {
    glColor3f(0.0f, 0.6f, 0.0f); // Verde para �rvore (pode mudar para cor da textura)
